			...
			<div className={styles.container}>
				...
				<div className={`${styles.heroContainer}`}>
					<div className={`${styles.uniformWidth}`}>
						<Link
							href={buyTicketsUrl[locale]}
							className={`${styles.buyTickets} ${styles.text1}`}
						>
				...
				<div className={`${styles.heroContainer}`}>
					<div className={`${styles.uniformWidth}`}>
						<div className={`${styles.text2} ${styles.textRed} ${styles.mT}`}>
							{"_"}
							{dictionary.whatYouNeed.title}:
						</div>
						<div className={styles.text2}>
							{dictionary.whatYouNeed.mandatory.title}:
						</div>
						<ul className={styles.subList}>
							<li className={styles.text3}>
								{dictionary.whatYouNeed.mandatory.helmet}
							</li>
							<li className={styles.text3}>
								{dictionary.whatYouNeed.mandatory.gloves}
							</li>
							<li className={styles.text3}>
								{dictionary.whatYouNeed.mandatory.signed}{" "}
								<Link href="#documents" className={`${styles.colRed}`}>
									{dictionary.whatYouNeed.mandatory.documents}
								</Link>
							</li>
						</ul>
						<div className={styles.text2}>
							{dictionary.whatYouNeed.optional.title}:
						</div>
						<ul className={styles.subList}>
							<li className={styles.text3}>
								{dictionary.whatYouNeed.optional.skateboard}
							</li>
							<li className={styles.text3}>
				...
				<div className={styles.heroContainer} id="documents">
					<div className={styles.uniformWidth}>
						...
						<ul className={styles.subList}>
							<li className={styles.text3}>
								<Link
									href="/documents/safety-adult.pdf"
									download
									className={styles.colRed}
								>
									{dictionary.documents.safetyAdult}
								</Link>
							</li>
							<li className={styles.text3}>
								<Link
									href="/documents/safety-minor.pdf"
									download
									className={styles.colRed}
								>
									{dictionary.documents.safetyMinor}
								</Link>
							</li>
							<li className={styles.text3}>
								<Link
									href="/documents/gdpr-adult.pdf"
									download
									className={styles.colRed}
								>
									{dictionary.documents.gdprAdult}
								</Link>
							</li>
							<li className={styles.text3}>
								<Link
									href="/documents/gdpr-minor.pdf"
									download
									className={styles.colRed}
								>
									{dictionary.documents.gdprMinor}
								</Link>
							</li>
						</ul>
						<div className={`${styles.text3} ${styles.mT}`}>
						...
						<ul className={styles.subList}>
							<li className={styles.text3}>
								<Link
									href="/documents/gdpr-guidelines.pdf"
									download
									className={styles.colRed}
								>
									{dictionary.documents.gdprGuidelines}
								</Link>
							</li>
							<li className={styles.text3}>
								<Link
									href="/documents/propozicia.pdf"
									download
									className={styles.colRed}
								>
									{dictionary.documents.guidelines}
								</Link>
							</li>
						</ul>
					</div>
